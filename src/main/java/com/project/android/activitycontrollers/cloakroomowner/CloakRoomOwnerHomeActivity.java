...
public class CloakRoomOwnerHomeActivity extends AppCompatActivity {
    private RadioGroup optionsRG;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cloakroomhome);
    ...
    public void initializeUIComponents()
    {
        ...
        optionsRG.check(R.id.addCloakRoom);
    }
    ...
    public void next(View view)
    {
        ...
        Intent i = null;
        if (selectedOption == R.id.addCloakRoom)
        {
            i = new Intent(getApplicationContext(),AddCloakRoomActivity.class);
        }
